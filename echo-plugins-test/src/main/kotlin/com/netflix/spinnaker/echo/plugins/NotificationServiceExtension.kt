...
@Extension
class NotificationServiceExtension : NotificationService {
  override fun supportsType(type: String?) = type == "extension_notification_type"

  override fun handle(notification: Notification?) = EchoResponse.Void()
}
